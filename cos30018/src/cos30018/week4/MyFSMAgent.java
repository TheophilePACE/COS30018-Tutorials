...
public class MyFSMAgent extends Agent {
	...
	// That behaviour just prints its name
	...
	// This behavior prints its name and exits with a random value between 0 and a given integer value
